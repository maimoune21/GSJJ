...
englishButton.addEventListener('click', (event) => {
    ...
    englishButton.setAttribute('aria-expanded', dropdownMenu.classList.contains('show'));
});

document.addEventListener('click', (event) => {
    if (!englishButton.contains(event.target) && !dropdownMenu.contains(event.target)) {
